<div class="min-height-200px">
	...
	<?php if ($this->session->userdata('role_id') < 4) { ?>
		<div class="card-box mb-30">
			<div class="pd-20">
				<h4 class="text-primary h4">Calon <?= $title; ?></h4>
			</div>
			<div class="pb-20">
				<table class="data-table table stripe hover nowrap">
					<thead>
						<tr>
							<th class="table-plus datatable-nosort">Acc</th>
							<th>Nama</th>
							<th>TTL</th>
							<th>JKL</th>
							<th>Status</th>
					...
					<tbody>
						<?php $i = 1; ?>
						<?php foreach ($getDataPenerimaLurah as $k) : ?>
							<tr>
								<td class="table-plus">
									...
									<?php } else  if ($this->session->userdata('role_id') == 4) { ?>
										<div class="form-check">
											<input type="checkbox" class="accStaff" value="<?php echo $k['id']; ?>" <?php if ($k['acc_staff'] == 1) echo "checked='checked'"; ?> data-toggle="checkbox">
										</div>
									<?php } ?>
		...
		<div class="card-box mb-30">
			...
			<div class="pb-20">
				<table class="data-table table stripe hover nowrap">
					...
					<tbody>
						<?php $i = 1; ?>
						<?php foreach ($getDataPenerimaAccLurah as $k) : ?>
							<tr>
		...
		<div class="card-box mb-30">
			...
			<div class="pb-20">
				<table class="data-table table stripe hover nowrap">
					...
					<tbody>
						<?php $i = 1; ?>
						<?php foreach ($getDataPenerima as $k) : ?>
							<tr>
								<td class="table-plus">
									<?php if ($this->session->userdata('role_id') < 3) { ?>
										<div class="form-check">
		...
		<div class="card-box mb-30">
			...
			<div class="pb-20">
				<table class="data-table table stripe hover nowrap">
					...
					<tbody>
						<?php $i = 1; ?>
						<?php foreach ($getDataPenerimaAcc as $k) : ?>
							<tr>
								<td class="table-plus"><?= $i++; ?></td>
								<td><?= $k['nama']; ?></td>
								<td><?= $k['tempat_lahir']; ?>,<br><?= $k['tgl_lahir']; ?></td>
