<div class="min-height-200px">
	...
	<div class="card-box mb-30">
		...
		<div class="pd-20">
			<?= form_open_multipart('informasi/addinformasi'); ?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-12 col-md-9">
					<select class="custom-select2 form-control" name="jenis_bantuan_id" style="width: 100%; height: 38px;">
						<option value="" selected="" disabled="">Jenis Bantuan</option>
			...
			<div class="form-group row">
				...
				<div class="col-sm-12 col-md-9">
					<input type="text" class="form-control date-picker" id="date_created" name="date_created" value="<?= set_value('date_created'); ?>" autocomplete="off">
